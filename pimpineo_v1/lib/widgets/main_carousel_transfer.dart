...
class MainCarouselTransfer extends StatefulWidget {
  
  
  @override
  _MainCarouselTransferState createState() => _MainCarouselTransferState();
}

class _MainCarouselTransferState extends State<MainCarouselTransfer> {
    ...
    return Column(
      ...
      children: <Widget>[
        Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          Icon(FontAwesomeIcons.exchangeAlt, color: Theme.of(context).primaryColor, size: 30.0,),
          SizedBox(width:12.0,),
          Text( //transferir credito
            'Transferir Credito',
            style: TextStyle(
